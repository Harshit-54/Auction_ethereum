...
contract BlindAuction {
    ...
    function encode(string str) public pure returns (bytes4){
        return bytes2(keccak256(abi.encodePacked(str)));
    }
    ...
    function bid(string _blindedBid)
        public payable
        ...
        // onlyBefore(revealEnd)
    {
        ...
        // require(keccak256(abi.encodePacked(bidToCheck.blindedBid)) == keccak256(abi.encodePacked(encodedBid)));
